describe('Ecml Renderer', function() {
    ...
    describe("When pause and resume events are called", function() {
        it("It should pause events", function() {
            window.Renderer = {'theme':org.ekstep.pluginframework.pluginManager.pluginInstances.theme};
            spyOn(ecmlRenderer, "pause").and.callThrough();
            ecmlRenderer.pause();
            expect(ecmlRenderer.pause).toHaveBeenCalled();
        });

        it("It should resume events", function() {
            window.Renderer = {'theme':org.ekstep.pluginframework.pluginManager.pluginInstances.theme};
            spyOn(ecmlRenderer, "resume").and.callThrough();
            ecmlRenderer.resume();
            expect(ecmlRenderer.resume).toHaveBeenCalled();
        });
