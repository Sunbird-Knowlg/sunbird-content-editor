describe('Assessment service test cases', function() {
    ...
    xit("should return questions using search service", function() {
        ...
        org.ekstep.services.assessmentService.http.post = jasmine.createSpy().and.callFake(function(url, data, headers, cb) {
    ...
    xit("should return error on getQuestions method call", function() {
        org.ekstep.services.assessmentService.http.post = jasmine.createSpy().and.callFake(function(url, data, headers, cb) {
    ...
    it("should return template using content service", function() {
        ...
        org.ekstep.services.assessmentService.http.get = jasmine.createSpy().and.callFake(function(url, headers, cb) {
