describe('language service test cases', function() {
    ...
    it("should return languages on getLanguages method call", function() {
        ...
        org.ekstep.services.languageService.http.get = jasmine.createSpy().and.callFake(function(url, headers, cb) {
    ...
    it("should return words on getWords method call", function() {
        ...
        org.ekstep.services.languageService.http.post = jasmine.createSpy().and.callFake(function(url, data, headers, cb) {
            cb(undefined, words);
        })
