EkstepEditor.preview_content = function() {
    var popupConfig = {
    ...
    previewModal.open(popupConfig).rendered.then(function() {
        ...
        function onPreviewContentIframeLoad(response) {
            ...
            data.theme.template=[];
            console.log("before preview data:",JSON.stringify(data));
            previewContentIframe.contentWindow.setContentData(null, data, config);
        };
    });
