describe('language service test cases', function() {
    ...
    it("should return languages on getLanguages method call", function() {
        ...
        EkstepEditor.languageService.http.get = jasmine.createSpy().and.callFake(function(url, headers, cb) {
            cb(undefined, languages);
        });
        spyOn(EkstepEditor.languageService, "getLanguages").and.callThrough();
        spyOn(EkstepEditor.languageService, "getFromService").and.callThrough();
        EkstepEditor.languageService.getLanguages(function(err, res) {
            expect(res).toBe(languages);
            expect(EkstepEditor.languageService.getFromService).toHaveBeenCalled();
            expect(EkstepEditor.languageService.getFromService.calls.count()).toBe(1);
        });
    });
    ...
    it("should return vowels on getVowel method call", function() {
        ...
        spyOn(EkstepEditor.languageService, "getVowel").and.callThrough();
        spyOn(EkstepEditor.languageService, "getFromService").and.callThrough();
        EkstepEditor.languageService.getVowel('en',function(err, res) {
    ...
    it("should return consonants on getConsonant method call", function() {
        ...
        spyOn(EkstepEditor.languageService, "getConsonant").and.callThrough();
        spyOn(EkstepEditor.languageService, "getFromService").and.callThrough();
        EkstepEditor.languageService.getConsonant('en',function(err, res) {
    ...
    it("should return words on getWords method call", function() {
        ...
        EkstepEditor.languageService.http.post = jasmine.createSpy().and.callFake(function(url, data, headers, cb) {
            cb(undefined, words);
        })
        spyOn(EkstepEditor.languageService, "getWords").and.callThrough();
        spyOn(EkstepEditor.languageService, "postFromService").and.callThrough();
        EkstepEditor.languageService.getWords(requestObj, function(err, res) {
            expect(res).toBe(words);
            expect(EkstepEditor.languageService.postFromService).toHaveBeenCalled();
            expect(EkstepEditor.languageService.postFromService.calls.count()).toBe(1);
        });
    });
    ...
    it("should return wordDefinition on getWordDefinition method call", function() {
        ...
        spyOn(EkstepEditor.languageService, "getWordDefinition").and.callThrough();
        spyOn(EkstepEditor.languageService, "getFromService").and.callThrough();
        EkstepEditor.languageService.getWordDefinition(function(err, res) {
            expect(res).toBe(words);
            expect(EkstepEditor.languageService.getFromService).toHaveBeenCalled();
            expect(EkstepEditor.languageService.getFromService.calls.count()).toBe(1);
        });
    ...
    it("should return keyWords on getKeyWords method call", function() {
        ...
        spyOn(EkstepEditor.languageService, "getKeyWords").and.callThrough();
        spyOn(EkstepEditor.languageService, "postFromService").and.callThrough();
        EkstepEditor.languageService.getKeyWords(requestData, function(err, res) {
